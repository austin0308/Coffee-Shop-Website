...
<?php
	...
	//   DO NOT CHANGE THE FOLLOWING LINES  //
		...
		$emailBody = "Hello $firstname, \n\nThank you so much for scheduling an event. We will get back to you as soon as possible (:\n\nBest,\nSavanna's Coffee House";			//stores the content of the email
		$contact = "Person inquiring to schedule an event: \n\n";
...
<head>
	...
	<title>Savanna's Scheduling</title>
</head>
...
<body>
	...
	<section class="php">
		 <h1>Thank you for scheduling an event!</h1>
	 </section>
